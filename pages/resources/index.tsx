...
const ResourceCard = ({ icon, title, children }: { icon: React.ReactNode, title: string, children: React.ReactNode }) => (
  <div className="bg-white dark:bg-slate-800 p-8 rounded-xl shadow-sm border border-slate-200 dark:border-slate-700 hover:shadow-lg transition-shadow duration-300">
    <div className="flex items-center gap-4 mb-4">
      <div className="bg-brand-100 dark:bg-brand-900/50 text-brand-700 dark:text-brand-400 p-3 rounded-full">
        {icon}
      </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
            ...
            <div className="lg:col-span-2 space-y-12">
                ...
                <ResourceCard icon={<Search size={24}/>} title="Finding the Right Scholarship">
                    ...
                    <ul className="list-disc list-inside space-y-2 pl-2 text-slate-500 dark:text-slate-400">
            ...
            <div className="lg:col-span-1 space-y-8">
                <div className="bg-white dark:bg-slate-800 p-6 rounded-xl shadow-sm border border-slate-200 dark:border-slate-700">
                    <h3 className="text-lg font-bold text-slate-900 dark:text-slate-100 mb-4 flex items-center gap-2"><Check size={20} className="text-brand-600 dark:text-brand-500"/> Application Checklist</h3>
                    <p className="text-sm text-slate-600 dark:text-slate-400 mb-6">Stay organized and ensure you have everything you need for a successful application.</p>
                    <a href="/FundedFutures_Application_Checklist.pdf" download className="w-full inline-flex items-center justify-center gap-2 py-3 px-4 rounded-lg font-semibold text-sm transition-colors duration-300 bg-brand-600 text-white hover:bg-brand-700 dark:bg-brand-500 dark:hover:bg-brand-600 shadow-md hover:shadow-lg">
                        <Download size={18} />
                ...
                <div className="bg-white dark:bg-slate-800 p-6 rounded-xl shadow-sm border border-slate-200 dark:border-slate-700">
                     <h3 className="text-lg font-bold text-slate-900 dark:text-slate-100 mb-4 flex items-center gap-2"><Award size={20} className="text-brand-600 dark:text-brand-500"/> Featured Scholarship</h3>
                     <div className="space-y-3">
                        <h4 className="font-semibold text-slate-800 dark:text-slate-200">Commonwealth Scholarship</h4>
                        <p className="text-sm text-slate-500 dark:text-slate-400">A prestigious award for Masters and PhD study in the UK. Covers fees, living expenses, and travel.</p>
                        <a href="#" className="inline-flex items-center gap-2 text-sm font-semibold text-brand-600 dark:text-brand-400 hover:underline">
