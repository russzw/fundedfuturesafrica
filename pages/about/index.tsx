      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mt-20">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
            {/* Mission */}
            <div className="text-center">
              <div className="flex items-center justify-center h-16 w-16 rounded-full bg-brand-100 dark:bg-brand-900/50 text-brand-600 dark:text-brand-400 mx-auto mb-6">
                <Target size={32} />
              </div>
            ...
            <div className="text-center">
              ...
              <h2 className="text-2xl font-bold text-slate-900 dark:text-slate-100">Who We Are</h2>
              <p className="mt-4 text-slate-500 dark:text-slate-400">
